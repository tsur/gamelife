...
export function getNeighboursFromAlive(x, y, i, possibleNeighboursList) {
...
export function removeCell(x, y, state) {
...
export function addCell(x, y, state) {
